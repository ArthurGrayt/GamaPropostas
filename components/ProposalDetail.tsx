                        ...
                        {!isEditingClient ? (
                            <>
                                ...
                                {proposal.cliente.telefone && (
                                    <h2 className="text-sm font-bold text-zinc-800 dark:text-white mb-1 flex items-center justify-center gap-2 group/phone">
                                        ...
                                        <button
                                            onClick={() => {
                                                navigator.clipboard.writeText(proposal.cliente.telefone!);
                                                // Optional: logic for temporary feedback can be added here if needed
                                            }}
                                            className="text-zinc-400 hover:text-blue-500 transition-colors opacity-40 hover:opacity-100 p-1"
                                            title="Copiar número"
                                        >
                                            <Copy size={12} />
                                        </button>
